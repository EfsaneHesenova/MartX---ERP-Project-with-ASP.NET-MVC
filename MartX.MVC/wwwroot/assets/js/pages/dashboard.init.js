...
// Ýlk grafik için renkleri al
var piechartColors1 = getChartColorsArray("#wallet-balance"),
    options1 = {
        series: [35, 70, 15],
...
// Ýlk grafik
var chart1 = new ApexCharts(document.querySelector("#wallet-balance"), options1);
chart1.render();

// Ýkinci grafik için renkleri al
...
// Ýkinci grafik
var chart2 = new ApexCharts(document.querySelector("#wallet-balance2"), options2);
chart2.render();
